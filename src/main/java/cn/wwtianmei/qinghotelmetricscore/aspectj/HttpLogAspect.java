package cn.wwtianmei.qinghotelmetricscore.aspectj;

import cn.hutool.core.lang.UUID;
import cn.wwtianmei.qinghotelmetricscore.annotations.HttpLog;
...
public class HttpLogAspect {
    @Pointcut("@annotation(cn.wwtianmei.qinghotelmetricscore.annotations.HttpLog)")
    public void logAnnotation() {
        log.info("HttpLogAspect切面");
    }

    private ThreadLocal<Long> startTimeThreadLocal = new ThreadLocal<Long>();
    private ThreadLocal<String> traceIdThreadLocal = new ThreadLocal<String>();
